...
const bool bDISPLAY_VEHICLE_DETECTCOLLISION = true;
const bool bDISPLAY_VEHICLE_COSTSTEPSTOCOLLISION = true;
const bool bDISPLAY_VEHICLE_COSTSPEEDININTENDEDLANE = true;
const bool bDISPLAY_VEHICLE_COSTTRAVELDISTANCE = true;
