...
// detect collision
double Trajectory::CostCollision(Vehicle ego, vector<Vehicle> vehicles, const double *weight) {
	
	// display message if required
	if (bDISPLAY && bDISPLAY_TRAJECTORY_COSTCOLLISION) {
		
		cout << "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = =" << endl;
		cout << "TRAJECTORY: CostCollision - Start" << endl;
	...
	if (DetectCollision(ego, vehicles)) {
	...
	if (bDISPLAY && bDISPLAY_TRAJECTORY_COST) {
		...
		cout << ": : : : : : : : : : : : : : : : : : : : : : : : : : : : : :" << endl;
		cout << "  cost: " << cost << endl;
		cout << "--- TRAJECTORY: CostCollision - End" << endl;
		cout << "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - -" << endl;
...
double Trajectory::Cost(Vehicle ego, vector<Vehicle> vehicles) {
	...
	// add collision costs
	cost =+ CostCollision(ego, vehicles, COST_COLLISON_WEIGHT);
